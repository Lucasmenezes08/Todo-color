...
export default function DeleteModal ({item , onDelete , onClose}){
    return createPortal(
        <section className='fixed inset-0 z-50 bg-black/60' onClick={onClose}>
            <dialog className='top-[calc(50%-130px)] left-[calc(50%-310px)] flex justify-center items-center rounded-2xl flex-col gap-6 w-[50%] h-[40vh]' open onClick={(e) => e.stopPropagation()}>
